...
export default class Context {
    ...
    constructor() {
         ...
         */
        this._rank;
        //static get rank() { return _rank; }
        //static set rank(value) { _rank = value; }
 ...
 * Les clusters Node
 */
//Context.clusterArduino;
//Context.clusterTwitter;
